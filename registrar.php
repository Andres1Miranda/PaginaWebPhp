    ...
    <header class="cabezera">
        <div class="cab_nav">
            ...
            <ul style="display: flex; justify-content: flex-end; padding: 0px 1250px;">
                ...
                <li><a href="registrar.php"></a></li>
            </ul>
        </div>
    </header>
    <form class="formulario_ing1" action="../PaginaWebPhP/php/registro.php" method="POST" id="reg_form">
        <h2 class="info_h2">Registro</h2>
        <input type="text" class="formula" required placeholder="Usuario" name="usuario2">
        <input type="password" class="formula" required placeholder="Contraseña" name="pass2">
